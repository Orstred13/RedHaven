...
namespace RedHaven.Enums.CyberwareEnums
{
    public enum CyberWareBorg
    {
        ...
        ImplantedLinearFrameBeta,   // Экзоскелет бетта (ТЕЛ 14, треб ТЕЛ 8 и "Исскуственные мышцы и усиление кости")
        MultiOpticMount,            // Фасеточное оптическое крепление (+5 глаз)
        SensorArray                 // Массив датчиков (+5 доп опций КиберАудио, треб КиберАудио)
    }
}