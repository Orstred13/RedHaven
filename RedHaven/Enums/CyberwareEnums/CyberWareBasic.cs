...
namespace RedHaven.Enums.CyberwareEnums
{
    public enum CyberWareBasic
    {
        ...
        CyberOptics,        //Оптика (3 слота на шт, можно 2шт)
        CyberAudio,         //Аудио (3 слота на шт, можно 1шт)
        InternalImplants,   //Внутрение импланты (7 слотов)
        ExternalImplants,   //Внешние импланты (7 слотов)
