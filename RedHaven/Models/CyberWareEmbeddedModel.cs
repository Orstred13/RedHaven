...
{
    public class CyberWareEmbeddedModel : CyberWareModel
    {
        public CyberWareEmbedded NameCyberWareEmbedded { get; set; }                      // Название
        ...
        public List<string> AdditionalOptions { get; set; }                         // Получаемые доп особенности
